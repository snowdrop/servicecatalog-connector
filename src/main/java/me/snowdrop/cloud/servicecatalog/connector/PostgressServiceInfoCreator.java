...
public class PostgressServiceInfoCreator extends RelationalDatabaseServiceInfoCreator<PostgresqlServiceInfo> {

    protected static final String SCHEME = "postgresql";
    protected static final String DEFAULT_PORT = "5432";


    public PostgressServiceInfoCreator() {
        super(ServiceCatalogClientRef.getClient());
    }

    public PostgressServiceInfoCreator(ServiceCatalogClient client) {
        super(client);
    }
